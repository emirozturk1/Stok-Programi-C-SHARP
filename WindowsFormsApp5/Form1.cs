    ...
    public partial class Form1 : Form
    {
       ...
       int id;
        ...
        private void textBox4_KeyPress(object sender, KeyPressEventArgs e)
        {
            ...
            {
                e.Handled = true;
                MessageBox.Show("Sadece Sayı Girişi Yapabilirsiniz !!! ", "UYARI", MessageBoxButtons.OK, MessageBoxIcon.Information);               
            }            
        }
        ...
        private void textBox1_KeyPress(object sender, KeyPressEventArgs e)
        {
            ...
            {
                e.Handled = true;
                MessageBox.Show("Sadece Harf Girişi Yapabilirsiniz !!! ", "UYARI", MessageBoxButtons.OK, MessageBoxIcon.Information);
            }        
        }
